"""Run Hybrid RAG benchmarking (fused BM25+Chroma with RRF + re-ranking, but no self-correction loop) against the clinical dataset."""
...
def main() -> None:
    ...
    print("\n--- Hybrid RAG (No Guardrails) Metrics ---")
